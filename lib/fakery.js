...
/**
 * Helper Factory class. Mainly acts as a 'mark' that this
 */
var Factory = function(name, model, attributes) {
    this.name = name;
    this.model = model;
...
var modelFromFactory = function(factory, overrides) {
...
var make = function(name, overrides) {
    ...
    return modelFromFactory(factory, overrides);
};
